...
insert into pro_mat (promat_cantidad, promat_costo, fk_proveedor, fk_tmat) values (261, 52, 11, 8);
insert into pro_mat (promat_cantidad, promat_costo, fk_proveedor, fk_tmat) values (272, 40, 6, 2);
insert into pro_mat (promat_cantidad, promat_costo, fk_proveedor, fk_tmat) values (280, 90, 3, 9);
...
insert into pro_mat (promat_cantidad, promat_costo, fk_proveedor, fk_tmat) values (260, 86, 25, 10);
...
insert into pro_mat (promat_cantidad, promat_costo, fk_proveedor, fk_tmat) values (290, 98, 16, 5);
...
insert into pro_mat (promat_cantidad, promat_costo, fk_proveedor, fk_tmat) values (272, 27, 30, 3);
